...
const record = [
  ...
  function superbowlWin(record){
    //create a variable for every win
    const win = record.find(myobj => myobj.result === "W")
    //tenary opetator or the if else staement to check if win constant met
